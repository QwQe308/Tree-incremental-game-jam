	...
	'tree-node': {
      ...
      v-if="tmp[layer].tooltip != ''"
			:text="(tmp[layer].isLayer) ? (
				...
				: (tmp[layer].tooltipLocked ? tmp[layer].tooltipLocked : 'Reach ' + formatWhole(tmp[layer].requires) + ' ' + tmp[layer].baseResource + ' 去解锁 (你有 ' + formatWhole(tmp[layer].baseAmount) + ' ' + tmp[layer].baseResource + ')')
			)
			: (
    ...
    'options-tab': {
        ...
        <table>
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('autosave')">自动保存: {{ options.autosave?"开":"OFF" }}</button></td>
            ...
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('offlineProd')">离线: {{ options.offlineProd?"ON":"OFF" }}</button></td>
            </tr>
            <tr>
