...
// data = a function returning the content (actually HTML)
	...
	Vue.component('clickable', {
		...
		<button 
			...
			v-bind:class="{ upg: true, can: tmp[layer].clickables[data].canClick, locked: !tmp[layer].clickables[data].canClick, tooltipBox:true}"
	...
	Vue.component('bar', {
		...
		template: `
		<div v-if="tmp[layer].bars && tmp[layer].bars[data].unlocked" v-bind:style="{'position': 'relative'}" class='tooltipBox'>
